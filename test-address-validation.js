...
const testCases = [
  // Valid testnet addresses
  {
    ...
    expected: true,
    type: 'segwit',
    description: 'Valid testnet SegWit (P2WPKH)',
  },
  {
    address: 'tb1p5d7rjq7g6rdk2yhzks9smlaqtedr4dekq08ge8ztwac72sfr9rusxg3297',
    expected: true,
    type: 'taproot',
    description: 'Valid testnet Taproot (P2TR)',
  },
  {
    address: '2MzQwSSnBHWHqSAqtTVQ6v47XtaisrJa1Vc',
    expected: true,
    type: 'legacy',
    description: 'Valid testnet P2SH',
  },
  {
    address: 'n1ZCYg9YXtB5XCZazLxSmPDa8iwJRZHhGx',
    expected: true,
    type: 'legacy',
    description: 'Valid testnet P2PKH',
  },
  ...
  // Valid addresses with whitespace (should pass after trimming)
  {
    ...
    expected: true,
    type: 'segwit',
    description: 'SegWit with whitespace',
  },
  ...
  // Invalid addresses
  {
    ...
    expected: false,
    description: 'Mainnet address (should reject)',
  },
  {
    address: '1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa',
    expected: false,
    description: 'Mainnet P2PKH (should reject)',
  },
  {
    address: '3J98t1WpEZ73CNmYviecrnyiWrnqRhWNLy',
    expected: false,
    description: 'Mainnet P2SH (should reject)',
  },
