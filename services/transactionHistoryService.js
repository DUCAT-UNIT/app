 ...
 * @param {string} segwitAddress - User's segwit address
 * @param {string} taprootAddress - User's taproot address
 * @returns {Object|null} { amount: bigint, type: 'UNIT' } or null
 */
 ...
 * @param {string} segwitAddress - User's segwit address
 * @param {string} taprootAddress - User's taproot address
 * @returns {Object} { amount: number|bigint, type: 'BTC'|'UNIT', isSelfTransfer?: boolean }
 */
export const calculateTransactionAmount = (tx, segwitAddress, taprootAddress) => {
 ...
 * @param {string} segwitAddress - User's segwit address
 * @param {string} taprootAddress - User's taproot address
 * @param {string} vaultPubkey - User's vault public key
 * @returns {Promise<Array>} Sorted array of all transactions
 */
