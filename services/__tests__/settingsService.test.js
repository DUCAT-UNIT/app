...
describe('getString', () => {
  ...
  it('should get string value from storage', async () => {
    SecureStore.getItemAsync.mockResolvedValue('testvalue');
...
describe('setBoolean', () => {
  ...
  it('should return false on error', async () => {
    SecureStore.setItemAsync.mockRejectedValue(new Error('Error'));
...
describe('getNumber', () => {
  ...
  it('should get number value', async () => {
    SecureStore.getItemAsync.mockResolvedValue('42');
  ...
  it('should get float number', async () => {
    SecureStore.getItemAsync.mockResolvedValue('3.14');
  ...
  it('should return default value for invalid number', async () => {
    SecureStore.getItemAsync.mockResolvedValue('notanumber');
...
describe('getObject', () => {
  ...
  it('should get object value', async () => {
    ...
    SecureStore.getItemAsync.mockResolvedValue(JSON.stringify(testObj));
...
describe('exists', () => {
  ...
  it('should return true when key exists', async () => {
    SecureStore.getItemAsync.mockResolvedValue('somevalue');
