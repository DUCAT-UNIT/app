  ...
  describe('totalBalanceBTC', () => {
    ...
    it('should calculate total BTC balance with BTC and UNIT', () => {
      const { result } = renderHook(() =>
        useWalletCalculations({
          segwitBalance: 1.0,
          runesBalance: [{ rune: 'UNIT', amount: '5000', divisibility: 0 }], // $5000 worth of UNIT
    ...
    it('should handle zero BTC price gracefully', () => {
      const { result } = renderHook(() =>
        useWalletCalculations({
          segwitBalance: 1.0,
          runesBalance: [{ rune: 'UNIT', amount: '5000', divisibility: 0 }],
          btcPrice: 0,
        })
      );
  ...
  describe('unitValueInBTC', () => {
    it('should calculate UNIT value in BTC', () => {
      const { result } = renderHook(() =>
        useWalletCalculations({
          segwitBalance: 1.0,
          runesBalance: [{ rune: 'UNIT', amount: '10000', divisibility: 0 }], // $10000 worth
          btcPrice: 50000,
        })
      );
    ...
    it('should return 0 when BTC price is 0', () => {
      const { result } = renderHook(() =>
        useWalletCalculations({
          segwitBalance: 1.0,
          runesBalance: [{ rune: 'UNIT', amount: '10000', divisibility: 0 }],
          btcPrice: 0,
        })
      );
