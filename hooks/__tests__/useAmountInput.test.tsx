...
describe('useAmountInput', () => {
  ...
  describe('balance calculation', () => {
    ...
    it('should use UNIT balance when sendAssetType is unit', () => {
      const { result } = renderHook(() =>
        useAmountInput({ ...defaultProps, sendAssetType: 'unit' })
      );
  ...
  describe('handleMaxPress - BTC', () => {
    it('should calculate max BTC using segwit address and balance', async () => {
      transactionCalculationService.calculateMaxSendableBTC.mockResolvedValue(0.75);
    ...
    it('should always use segwit address for BTC regardless of destination', async () => {
      transactionCalculationService.calculateMaxSendableBTC.mockResolvedValue(0.6);
    ...
    it('should set isCalculatingMax during calculation', async () => {
      ...
      transactionCalculationService.calculateMaxSendableBTC.mockReturnValue(calculationPromise);
    ...
    it('should fallback to segwit balance on error', async () => {
      transactionCalculationService.calculateMaxSendableBTC.mockRejectedValue(
  ...
  describe('calculateUsdValue', () => {
    ...
    it('should return 0.00 for null amount', () => {
      ...
      const usdValue = result.current.calculateUsdValue(null, 50000);
