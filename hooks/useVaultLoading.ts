...
interface UseVaultLoadingReturn {
  isLoading: boolean;
  setIsLoading: Dispatch<SetStateAction<boolean>>;
  preparingVault: boolean;
  setPreparingVault: Dispatch<SetStateAction<boolean>>;
  preparingMessage: string;
  shouldShowLoading: boolean;
}

export function useVaultLoading(visible: boolean): UseVaultLoadingReturn {
