...
describe('WalletContext', () => {
  ...
  it('should load wallet from storage successfully', async () => {
    (WalletService.loadWalletFromStorage as jest.Mock).mockResolvedValueOnce({
  ...
  it('should switch account successfully', async () => {
    const newAddresses = {
      ...
      segwitPubkey: 'newsegwitpubkey123',
  ...
  it('should propagate switch account error', async () => {
    (WalletService.switchToAccount as jest.Mock).mockRejectedValueOnce(new Error('Switch error'));
