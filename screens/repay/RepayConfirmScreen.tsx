 ...
 *
 * @deprecated Use RepayConfirmScreenNew from screens/vault/screens instead.
...
export default function RepayConfirmScreen({ navigation }: RepayConfirmScreenProps) {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']} testID="vault-repay-confirm-screen">
      <ScrollView
      ...
      <View style={styles.footer}>
        ...
        <TouchableScale
          ...
          disabled={isLoading || isAuthenticating}
          testID="vault-repay-confirm-btn"
        >
          {isAuthenticating ? (
