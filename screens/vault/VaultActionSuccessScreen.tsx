/**
 * VaultActionSuccessScreen - Shared success screen for all vault actions
 * Used by: Deposit, Withdraw, Borrow, Repay
 */
...
type VaultActionSuccessScreenProps = StackScreenProps<VaultActionSuccessParams, 'VaultActionSuccess'>;
...
export default function VaultActionSuccessScreen({ navigation, route }: VaultActionSuccessScreenProps) {
  const { actionType, amount, usdValue, txid, unit } = route.params;
  ...
  // Handle done - go to vault detail page
