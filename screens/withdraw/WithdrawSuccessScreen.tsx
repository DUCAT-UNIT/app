    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>
          You have successfully withdrawn {formatBTC(withdrawAmountBtc)} BTC
        </Text>
        <Text style={styles.subtitleUsd}>≈ {formatFiat(withdrawUsdValue)}</Text>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Your BTC withdrawal has been processed. The funds will be sent to your wallet. It may take a few minutes for the transaction to confirm on the network.
          </Text>
        </View>
      </View>
