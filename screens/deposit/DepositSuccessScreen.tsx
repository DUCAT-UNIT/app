    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>
          You have successfully deposited {formatBTC(depositAmountBtc)} BTC
        </Text>
        <Text style={styles.subtitleUsd}>≈ {formatFiat(depositUsdValue)}</Text>
        ...
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Your collateral has been added to the vault. Your vault health has improved. It may take a few minutes for the transaction to confirm on the network.
          </Text>
        </View>
      </View>
