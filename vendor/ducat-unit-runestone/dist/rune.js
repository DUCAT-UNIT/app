...
export class Rune {
    ...
    static getMinimumAtHeight(chain, height) {
        ...
        const endSubsidyInterval = u128.saturatingAdd(startSubsidyInterval, u128(SUBSIDY_HALVING_INTERVAL));
        ...
        return new Rune(u128(endStepInterval - ((endStepInterval - startStepInterval) * remainder) / INTERVAL));
    }
    get reserved() {
    ...
    get commitment() {
        ...
        view.setBigUint64(0, 0xffffffffffffffffn & this.value, true);
