...
export declare namespace RuneLocation {
    function toString(runeId: RuneLocation): string;
}
export type RuneSpentUtxoBalance = RuneUtxoBalance & {
    spentTxid: string;
};
...
export type RuneEtchingSpec = RuneEtchingBase & {
    runeName?: string;
};
