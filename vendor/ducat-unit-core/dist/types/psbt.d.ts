...
import type { TaprootControlBlock, TransactionInput, TransactionOutput } from '@scure/btc-signer/psbt.js';
...
export type PSBTFullInput = PSBTInput & {
    txid: string;
    index: number;
    witnessUtxo: PSBTPrevouts;
};
export type PSBTFullOutput = PSBTOutput & {
    amount: bigint;
    script: Uint8Array;
};
